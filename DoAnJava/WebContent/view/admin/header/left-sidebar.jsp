    ...
    <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
      <div class="brand-logo">
        <a href="${pageContext.request.contextPath}/admin/homepage">
          ...
          <h5 class="logo-text">Admin Web SENDA</h5>
        </a>
      </div>
      <ul class="sidebar-menu do-nicescrol">
        ...
        <li>
          <a href="${pageContext.request.contextPath}/admin/exchange/list">
            <i class="zmdi zmdi-calendar-check"></i> <span>Bài viết người dùng</span>
          </a>
        </li>
        <li>
          <a href="${pageContext.request.contextPath}/admin/comment/list">
            <i class="icon-envelope-open"></i> <span>Bình luận bài viết</span>
          </a>
        </li>
      </ul>
    </div>